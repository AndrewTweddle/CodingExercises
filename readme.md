...
|     |                                                                           | 2022-09-17 | [Rust](project_euler/src/bin/problem39_v2.rs)                        | Duration: 3 µs. Using [the formula for generating Pythagorean triples](https://en.wikipedia.org/wiki/Pythagorean_triple#Generating_a_triple).                                                                                      |
