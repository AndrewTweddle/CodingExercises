...
|     |                                                                           | 2021-09-06 | [Rust](project_euler/src/bin/problem12_prime_factors.rs)             | Duration: 1.470898ms. I had a brainwave! T(n) = n*(n+1)/2. n and n+1 are relatively prime. Hence # of divisors of T(n) is the product of # of divisors of n/2 and n+1 (if n is even) or n and (n+1)/2 if odd. |
| ... | ...                                                                       |            |                                                                      |                                                                                                                                                                                                               |
