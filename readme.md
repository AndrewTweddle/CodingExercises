...
|                                                              |                                                | 2021-05-11 | [Rust (TDD) - May 2021](Katas/CodingDojo/roman_numerals/src/main.rs)                                                  | Experiment with TDD and with quickcheck property-based testing.                                                          |
...
|     |                                                                           | 2021-05-20 | [Rust](project_euler/src/bin/problem17.rs)                           | Duration: 9ns. Code on my own using a more intuitive approach. This was simple, succinct and lightning fast, but also brittle and tricky to get right.                                                        |
