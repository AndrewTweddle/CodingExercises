...
| Problem | Description                                                      | Date       | Solution                                  | Notes                                                                                                                                                                        |
|---------|------------------------------------------------------------------|------------|-------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| 4       | [Largest Palindrome Product](https://projecteuler.net/problem=4) | 2021-04-12 | [Rust](project_euler/src/bin/problem4.rs) | Experimented with, and timed, various methods of calculating primes.                                                                                                         |
| 5       | [Smallest Multiple](https://projecteuler.net/problem=5)          | 2021-04-12 | [Rust](project_euler/src/bin/problem5.rs) | Experimented with, and timed, various methods of calculating primes.                                                                                                         |
