...
| Problem | Description                                                      | Date | Solution | Notes                                                                                                                                                                        | Forum page with my solution (if shared)                                                   |
|---------|------------------------------------------------------------------|------|----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
...
| 16      | [Power digit sum](https://projecteuler.net/problem=16)           |      |          | Problem: sum of decimal digits in 2^1000. I'm proud of the very different approach I found (which also ran extremely quickly). It earned some kudos from other participants. | [Various Rust solutions](https://projecteuler.net/thread=16;page=8#381420)                |
| 17      | [Number Letter Counts](https://projecteuler.net/problem=17)      |      |          | TDD solution pair programmed with a colleague, and a faster, shorter one done on my own                                                                                      | [Two Rust solutions](https://projecteuler.net/thread=17;page=8#382439)                    |
| 18 - 29 | ...                                                              |      |          |                                                                                                                                                                              |                                                                                           |
