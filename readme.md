...
| 16  | [Power digit sum](https://projecteuler.net/problem=16)                     | 2021-05-02 | [Rust](project_euler/src/bin/problem16.rs)                           | Duration: 35.839µs. Problem: sum of decimal digits in 2^1000. Solution: Use base 10^19 < 2^64. Store digits as u128. So squaring a digit and adding a carry will not overflow. 2^1000 = ((((2^125)^2)^2)^2.   |
