...
| 41 | [Pandigital prime](https://projecteuler.net/problem=41)                   | 2023-05-14 | [Rust](project_euler/src/bin/problem41.rs)                           | Duration: 5.5 µs (excluding writing to console). Used the [factorial number system](https://en.wikipedia.org/wiki/Factorial_number_system) to implement a descending iterator over pandigital numbers.                              |
...
| Day                                      | Problem                     | Part  | Date Solved | My solution                                                              | Notes                                           |
|------------------------------------------|-----------------------------|-------|-------------|--------------------------------------------------------------------------|-------------------------------------------------|
